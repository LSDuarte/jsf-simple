...
public class PopulaBanco {
	...
	public static void main(String[] args) {
		...
		Livro memorias = geraLivro("978-8-50-815415-9", "Memórias Póstumas de Brás Cubas","01/01/1881",19.90,amado);
		...
		Livro maao = geraLivro("978-8-51-892238-9", "O Diário de um Mago","01/01/1887",9.90,coelho);
		...
		Livro capitaes = geraLivro("978-8-52-831169-1", "Capitães da Areia","01/01/1937",6.90,amado);
